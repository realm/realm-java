...
import io.realm.examples.realmadapters.adapters.RealmPersonExampleAdapter;
import io.realm.examples.realmadapters.model.SimpleRecord;

public class RealmPersonAdapterExampleActivity extends Activity implements View.OnClickListener {

    @SuppressWarnings("UnusedDeclaration")
    public static final String TAG = RealmPersonAdapterExampleActivity.class.getName();

    private Realm realm = null;

    private RealmPersonExampleAdapter mAdapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new RealmPersonExampleAdapter(this, R.layout.simplelistitem, rList);
