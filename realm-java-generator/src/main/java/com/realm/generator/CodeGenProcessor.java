...
public class CodeGenProcessor extends AbstractAnnotationProcessor {
    ...
    private static final String MSG_INCORRECT_TYPE = "Incorrect data type was specified! Expected primitive or wrapper type, byte[], java.lang.Object or java.util.Date!";

    private static final String MSG_NO_COLUMNS = "The table specification must have at least one valid field/column specified!";

    private static final String DEFAULT_PACKAGE = "com.realm.generated";
    ...
    static {
        INTEGER_TYPES = new HashSet<String>(Arrays.asList("long", "int", "byte", "short", "java.lang.Long",
