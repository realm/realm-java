...
### Fixed
* Enable support for incremental builds on the bytecode transformation. It will improve the overall build speed. (Issue [#7802](https://github.com/realm/realm-java/issues/7802))
