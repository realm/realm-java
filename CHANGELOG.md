...
* @PrimaryKey field value can be null for java.lang.String type, and should be migrated by using io.realm.internal.Table.convertColumnToNullable() for older version of Realm (#2515).
