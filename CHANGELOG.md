...
* Added `OrderedRealmCollectionSnapshot` class and `OrderedRealmCollection.createSnapshot()` methods. `OrderedRealmCollectionSnapshot` would be useful when changing `RealmResults` or `RealmList` in simple loops.
