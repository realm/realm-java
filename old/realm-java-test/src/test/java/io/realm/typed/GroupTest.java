...
public class GroupTest {
    ...
    public void shouldOpenExistingGroupFile() throws IOException {
        ...
        Group group3 = new Group(FILENAME, Group.OpenMode.READ_ONLY);
        group3.close();

        Group group4 = new Group(FILENAME, Group.OpenMode.READ_WRITE);
        group4.close();

        Group group5 = new Group(FILENAME, Group.OpenMode.READ_WRITE_NO_CREATE);
        group5.close();
    }
    ...
    public void shouldThrowExceptionOnGroupReadOnly() throws IOException {
        ...
        try { Group group = new Group(FILENAME, Group.OpenMode.READ_ONLY); fail("Group is read only"); } catch (io.realm.IOException e) { }
    }
    ...
    public void shouldThrowExceptionOnOpenWrongFileReadOnly() throws IOException {
        ...
        Group group = new Group(FILENAME, Group.OpenMode.READ_ONLY);
    }

    @Test
    public void ThrowExceptionOnGroupNoCreate() throws IOException {
        new File(FILENAME).delete();
        try { Group group2 = new Group(FILENAME, Group.OpenMode.READ_WRITE_NO_CREATE); fail("Exception excpected"); } catch (io.realm.IOException e) { }
    }
    ...
    @Test(expectedExceptions = io.realm.IOException.class)
    ...
    public void groupNoOverwrite1() throws IOException {
        ...
        try { group.writeToFile(FILENAME); fail("writing to same file"); } catch (io.realm.IOException e) { }
    }
