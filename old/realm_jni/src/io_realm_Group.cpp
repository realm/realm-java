...
#include "util.hpp"
#include "io_realm_Group.h"

using namespace tightdb;
using std::string;

JNIEXPORT jlong JNICALL Java_io_realm_Group_createNative__(
    JNIEnv* env, jobject)
{
    Group *ptr = new Group();
...
JNIEXPORT jlong JNICALL Java_io_realm_Group_createNative__Ljava_lang_String_2I(
...
JNIEXPORT jlong JNICALL Java_io_realm_Group_createNative___3B(
...
JNIEXPORT jlong JNICALL Java_io_realm_Group_createNative__Ljava_nio_ByteBuffer_2(
...
JNIEXPORT void JNICALL Java_io_realm_Group_nativeClose(
...
JNIEXPORT jlong JNICALL Java_io_realm_Group_nativeSize(
    JNIEnv*, jobject, jlong nativeGroupPtr)
{
    return static_cast<jlong>( G(nativeGroupPtr)->size() ); // noexcept
}

JNIEXPORT jboolean JNICALL Java_io_realm_Group_nativeHasTable(
...
JNIEXPORT jstring JNICALL Java_io_realm_Group_nativeGetTableName(
...
JNIEXPORT jlong JNICALL Java_io_realm_Group_nativeGetTableNativePtr(
...
JNIEXPORT void JNICALL Java_io_realm_Group_nativeWriteToFile(
...
JNIEXPORT jbyteArray JNICALL Java_io_realm_Group_nativeWriteToMem(
...
JNIEXPORT jobject JNICALL Java_io_realm_Group_nativeWriteToByteBuffer(
    JNIEnv* env, jobject, jlong nativeGroupPtr)
{
...
JNIEXPORT void JNICALL Java_io_realm_Group_nativeCommit(
    JNIEnv*, jobject, jlong nativeGroupPtr)
{
...
JNIEXPORT jstring JNICALL Java_io_realm_Group_nativeToJson(
    JNIEnv* env, jobject, jlong nativeGroupPtr)
{
...
JNIEXPORT jstring JNICALL Java_io_realm_Group_nativeToString(
    JNIEnv* env, jobject, jlong nativeGroupPtr)
{
    Group* grp = G(nativeGroupPtr);
    try {
...
JNIEXPORT jboolean JNICALL Java_io_realm_Group_nativeEquals(
