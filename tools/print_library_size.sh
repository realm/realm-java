...
# This script will print the size of the Realm libraries.
# To run it:
#   1. Make sure that $D8 is defined in your environment, e.g. `D8="$ANDROID_SDK_ROOT/build-tools/29.0.2/d8"`
#   2. Make sure that you have built the library artifacts using ./gradlew assemble from the realm folder.
#   3. Run the script: `> sh ./print_library_size.sh`
#
