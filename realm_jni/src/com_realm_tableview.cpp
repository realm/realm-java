...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_createNativeTableView(
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativePivot(
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeClose(
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeSize(
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeGetSourceRowIndex
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeGetColumnCount
  (JNIEnv *env, jobject, jlong nativeViewPtr)
{
    if (!VIEW_VALID(env, nativeViewPtr))
        return 0;
...
JNIEXPORT jstring JNICALL Java_com_realm_TableView_nativeGetColumnName
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeGetColumnIndex
...
JNIEXPORT jint JNICALL Java_com_realm_TableView_nativeGetColumnType
  (JNIEnv *env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) || !COL_INDEX_VALID(env, TV(nativeViewPtr), columnIndex))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeGetLong(
...
JNIEXPORT jboolean JNICALL Java_com_realm_TableView_nativeGetBoolean(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
...
JNIEXPORT jfloat JNICALL Java_com_realm_TableView_nativeGetFloat(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableView_nativeGetDouble(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeGetDateTimeValue(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
...
JNIEXPORT jstring JNICALL Java_com_realm_TableView_nativeGetString(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
...
/*
JNIEXPORT jobject JNICALL Java_com_realm_TableView_nativeGetBinary(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
...
JNIEXPORT jbyteArray JNICALL Java_com_realm_TableView_nativeGetByteArray(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, rowIndex, type_Binary))
...
JNIEXPORT jint JNICALL Java_com_realm_TableView_nativeGetMixedType(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
...
JNIEXPORT jobject JNICALL Java_com_realm_TableView_nativeGetMixed(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, rowIndex, type_Mixed))
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeGetSubtableSize(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeGetSubtable(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeClearSubtable(
   JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, rowIndex, type_Table))
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeSetLong(
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeSetBoolean(
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeSetFloat(
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeSetDouble(
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeSetDateTimeValue(
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeSetString(
...
/*
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeSetBinary(
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeSetByteArray(
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeSetMixed(
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeAddInt(
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeClear(
    JNIEnv* env, jobject, jlong nativeViewPtr)
{
    if (!VIEW_VALID(env, nativeViewPtr))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeRemoveRow(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong rowIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeFindFirstInt(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong value)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeFindFirstBool(
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeFindFirstFloat(
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeFindFirstDouble(
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeFindFirstDate(
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeFindFirstString(
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeFindAllInt(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong value)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Int))
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeFindAllBool(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jboolean value)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Bool))
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeFindAllFloat(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jfloat value)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Float))
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeFindAllDouble(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jdouble value)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Double))
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeFindAllDate(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jlong dateTimeValue)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_DateTime))
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeFindAllString(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex, jstring value)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_String))
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeSumInt(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Int))
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableView_nativeAverageInt(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Int))
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeMaximumInt(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Int))
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeMinimumInt(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Int))
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableView_nativeSumFloat(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Float))
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableView_nativeAverageFloat(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Float))
...
JNIEXPORT jfloat JNICALL Java_com_realm_TableView_nativeMaximumFloat(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Float))
...
JNIEXPORT jfloat JNICALL Java_com_realm_TableView_nativeMinimumFloat(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Float))
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableView_nativeSumDouble(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Double))
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableView_nativeAverageDouble(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Double))
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableView_nativeMaximumDouble(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Double))
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableView_nativeMinimumDouble(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_Double))
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeMaximumDate(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_DateTime))
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeMinimumDate(
    JNIEnv* env, jobject, jlong nativeViewPtr, jlong columnIndex)
{
    if (!VIEW_VALID(env, nativeViewPtr) ||
        !COL_INDEX_AND_TYPE_VALID(env, TV(nativeViewPtr), columnIndex, type_DateTime))
...
JNIEXPORT void JNICALL Java_com_realm_TableView_nativeSort(
...
JNIEXPORT jstring JNICALL Java_com_realm_TableView_nativeToJson(
    JNIEnv *env, jobject, jlong nativeViewPtr)
{
...
JNIEXPORT jstring JNICALL Java_com_realm_TableView_nativeToString(
...
JNIEXPORT jstring JNICALL Java_com_realm_TableView_nativeRowToString(
    JNIEnv *env, jobject, jlong nativeViewPtr, jlong rowIndex)
{
    TableView* tv = TV(nativeViewPtr);
...
JNIEXPORT jlong JNICALL Java_com_realm_TableView_nativeWhere
  (JNIEnv *env, jobject, jlong nativeViewPtr)
{
    if (!VIEW_VALID(env, nativeViewPtr))
        return 0;
