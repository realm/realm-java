#include "util.hpp"
#include "com_realm_TableQuery.h"
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeClose(JNIEnv * env, jclass, jlong nativeQueryPtr) {
    TR((env, "Query nativeClose(ptr %x)\n", nativeQueryPtr));
    delete Q(nativeQueryPtr);
}

JNIEXPORT jstring JNICALL Java_com_realm_TableQuery_nativeValidateQuery
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeEqual__JJJ(
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeNotEqual__JJJ(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jlong value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Int))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeGreater__JJJ(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jlong value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Int))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeGreaterEqual__JJJ(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jlong value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Int))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeLess__JJJ(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jlong value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Int))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeLessEqual__JJJ(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jlong value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Int))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeBetween__JJJJ(
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeEqual__JJF(
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeNotEqual__JJF(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jfloat value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Float))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeGreater__JJF(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jfloat value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Float))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeGreaterEqual__JJF(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jfloat value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Float))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeLess__JJF(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jfloat value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Float))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeLessEqual__JJF(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jfloat value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Float))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeBetween__JJFF(
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeEqual__JJD(
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeNotEqual__JJD(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jdouble value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Double))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeGreater__JJD(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jdouble value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Double))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeGreaterEqual__JJD(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jdouble value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Double))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeLess__JJD(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jdouble value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Double))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeLessEqual__JJD(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jdouble value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_Double))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeBetween__JJDD(
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeEqualDateTime(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jlong value)
{
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeNotEqualDateTime(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jlong value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_DateTime))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeGreaterDateTime(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jlong value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_DateTime))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeGreaterEqualDateTime(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jlong value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_DateTime))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeLessDateTime(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jlong value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_DateTime))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeLessEqualDateTime(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jlong value)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_DateTime))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeBetweenDateTime(
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeEqual__JJZ(
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeEqual__JJLjava_lang_String_2Z(
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeBeginsWith(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jstring value, jboolean caseSensitive)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_String))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeEndsWith(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jstring value, jboolean caseSensitive)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_String))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeContains(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jstring value, jboolean caseSensitive)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_String))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeNotEqual__JJLjava_lang_String_2Z(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong columnIndex, jstring value, jboolean caseSensitive)
{
    if (!QUERY_COL_TYPE_VALID(env, nativeQueryPtr, columnIndex, type_String))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeTableview(
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeGroup(
    JNIEnv* env, jobject, jlong nativeQueryPtr)
{
    Query* pQuery = Q(nativeQueryPtr);
    if (!QUERY_VALID(env, pQuery))
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeEndGroup(
    JNIEnv* env, jobject, jlong nativeQueryPtr)
{
    Query* pQuery = Q(nativeQueryPtr);
    if (!QUERY_VALID(env, pQuery))
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeOr(
    JNIEnv* env, jobject, jlong nativeQueryPtr)
{
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeSubtable(
...
JNIEXPORT void JNICALL Java_com_realm_TableQuery_nativeParent(
    JNIEnv* env, jobject, jlong nativeQueryPtr)
{
    TableQuery* pTQuery = TQ(nativeQueryPtr);
    if (!QUERY_VALID(env, pTQuery))
...
JNIEXPORT jlong JNICALL Java_com_realm_TableQuery_nativeFind(
...
JNIEXPORT jlong JNICALL Java_com_realm_TableQuery_nativeFindAll(
...
JNIEXPORT jlong JNICALL Java_com_realm_TableQuery_nativeSumInt(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
...
JNIEXPORT jlong JNICALL Java_com_realm_TableQuery_nativeMaximumInt(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jlong JNICALL Java_com_realm_TableQuery_nativeMinimumInt(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableQuery_nativeAverageInt(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableQuery_nativeSumFloat(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jfloat JNICALL Java_com_realm_TableQuery_nativeMaximumFloat(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jfloat JNICALL Java_com_realm_TableQuery_nativeMinimumFloat(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableQuery_nativeAverageFloat(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableQuery_nativeSumDouble(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableQuery_nativeMaximumDouble(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableQuery_nativeMinimumDouble(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jdouble JNICALL Java_com_realm_TableQuery_nativeAverageDouble(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jlong JNICALL Java_com_realm_TableQuery_nativeMaximumDate(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jlong JNICALL Java_com_realm_TableQuery_nativeMinimumDate(
    JNIEnv* env, jobject, jlong nativeQueryPtr,
    jlong columnIndex, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
...
JNIEXPORT jlong JNICALL Java_com_realm_TableQuery_nativeCount(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
    Table* pTable = Ref2Ptr(pQuery->get_table());
...
JNIEXPORT jlong JNICALL Java_com_realm_TableQuery_nativeRemove(
    JNIEnv* env, jobject, jlong nativeQueryPtr, jlong start, jlong end, jlong limit)
{
    Query* pQuery = Q(nativeQueryPtr);
    Table* pTable = Ref2Ptr(pQuery->get_table());
