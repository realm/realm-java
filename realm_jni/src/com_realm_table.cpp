...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeAddColumn
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativePivot
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeRemoveColumn
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeRenameColumn
...
JNIEXPORT jboolean JNICALL Java_com_realm_Table_nativeIsRootTable
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeUpdateFromSpec(
...
JNIEXPORT jobject JNICALL Java_com_realm_Table_nativeGetTableSpec(
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeSize(
    JNIEnv* env, jobject, jlong nativeTablePtr)
{
    if (!TABLE_VALID(env, TBL(nativeTablePtr)))
        return 0;
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeClear(
    JNIEnv* env, jobject, jlong nativeTablePtr)
{
    if (!TABLE_VALID(env, TBL(nativeTablePtr)))
        return;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeGetColumnCount(
    JNIEnv* env, jobject, jlong nativeTablePtr)
{
    if (!TABLE_VALID(env, TBL(nativeTablePtr)))
        return 0;
...
JNIEXPORT jstring JNICALL Java_com_realm_Table_nativeGetColumnName(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_VALID(env, TBL(nativeTablePtr), columnIndex))
        return NULL;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeGetColumnIndex(
...
JNIEXPORT jint JNICALL Java_com_realm_Table_nativeGetColumnType(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_VALID(env, TBL(nativeTablePtr), columnIndex))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeAddEmptyRow(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeRemove(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeRemoveLast(
    JNIEnv* env, jobject, jlong nativeTablePtr)
{
    if (!TABLE_VALID(env, TBL(nativeTablePtr)))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeMoveLastOver
  (JNIEnv *env, jobject, jlong nativeTablePtr, jlong rowIndex)
{
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeInsertLong(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeInsertBoolean(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeInsertFloat(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeInsertDouble(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeInsertDate(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeInsertString(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeInsertMixed(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeSetMixed(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex, jobject jMixedValue)
{
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeInsertSubtable(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeInsertDone(
    JNIEnv* env, jobject, jlong nativeTablePtr)
{
    if (!TABLE_VALID(env, TBL(nativeTablePtr)))
        return;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeGetLong(
...
JNIEXPORT jboolean JNICALL Java_com_realm_Table_nativeGetBoolean(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
...
JNIEXPORT jfloat JNICALL Java_com_realm_Table_nativeGetFloat(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
...
JNIEXPORT jdouble JNICALL Java_com_realm_Table_nativeGetDouble(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeGetDateTime(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
...
JNIEXPORT jstring JNICALL Java_com_realm_Table_nativeGetString(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
...
/*
JNIEXPORT jobject JNICALL Java_com_realm_Table_nativeGetByteBuffer(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
...
JNIEXPORT jbyteArray JNICALL Java_com_realm_Table_nativeGetByteArray(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
    if (!TBL_AND_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, rowIndex, type_Binary))
        return NULL;
...
JNIEXPORT jint JNICALL Java_com_realm_Table_nativeGetMixedType(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
...
JNIEXPORT jobject JNICALL Java_com_realm_Table_nativeGetMixed(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
    if (!TBL_AND_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, rowIndex, type_Mixed))
        return NULL;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeGetSubtable(
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeGetSubtableDuringInsert(
    JNIEnv* env, jobject jTableBase, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
    if (!TBL_AND_INDEX_AND_TYPE_INSERT_VALID(env, TBL(nativeTablePtr), columnIndex, rowIndex, type_Table))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeGetSubtableSize(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
    if (!TBL_AND_INDEX_AND_TYPE_VALID_MIXED(env, TBL(nativeTablePtr), columnIndex, rowIndex, type_Table))
        return 0;
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeSetLong(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex, jlong value)
{
    if (!TBL_AND_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, rowIndex, type_Int))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeSetBoolean(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex, jboolean value)
{
    if (!TBL_AND_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, rowIndex, type_Bool))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeSetFloat(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex, jfloat value)
{
    if (!TBL_AND_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, rowIndex, type_Float))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeSetDouble(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex, jdouble value)
{
    if (!TBL_AND_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, rowIndex, type_Double))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeSetString(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex, jstring value)
{
    if (!TBL_AND_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, rowIndex, type_String))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeSetDate(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex, jlong dateTimeValue)
{
    if (!TBL_AND_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, rowIndex, type_DateTime))
        return;
...
/*
JNIEXPORT void JNICALL Java_com_realm_Table_nativeSetByteBuffer(
...
*/
/*
JNIEXPORT void JNICALL Java_com_realm_Table_nativeInsertByteBuffer(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex, jobject byteBuffer)
{
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeSetByteArray(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeInsertByteArray(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex, jbyteArray dataArray)
{
    if (!TBL_AND_INDEX_AND_TYPE_INSERT_VALID(env, TBL(nativeTablePtr), columnIndex, rowIndex, type_Binary))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeAddInt(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeClearSubtable(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
    if (!TBL_AND_INDEX_VALID(env, TBL(nativeTablePtr), columnIndex, rowIndex))
        return;
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeSetIndex(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    Table* pTable = TBL(nativeTablePtr);
    if (!TBL_AND_COL_INDEX_VALID(env, pTable, columnIndex))
...
JNIEXPORT jboolean JNICALL Java_com_realm_Table_nativeHasIndex(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_VALID(env, TBL(nativeTablePtr), columnIndex))
        return false;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeSumInt(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeMaximumInt(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Int))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeMinimumInt(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Int))
        return 0;
...
JNIEXPORT jdouble JNICALL Java_com_realm_Table_nativeAverageInt(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Int))
        return 0;
...
JNIEXPORT jdouble JNICALL Java_com_realm_Table_nativeSumFloat(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
...
JNIEXPORT jfloat JNICALL Java_com_realm_Table_nativeMaximumFloat(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Float))
        return 0;
...
JNIEXPORT jfloat JNICALL Java_com_realm_Table_nativeMinimumFloat(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Float))
        return 0;
...
JNIEXPORT jdouble JNICALL Java_com_realm_Table_nativeAverageFloat(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Float))
        return 0;
...
JNIEXPORT jdouble JNICALL Java_com_realm_Table_nativeSumDouble(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
...
JNIEXPORT jdouble JNICALL Java_com_realm_Table_nativeMaximumDouble(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Double))
        return 0;
...
JNIEXPORT jdouble JNICALL Java_com_realm_Table_nativeMinimumDouble(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Double))
        return 0;
...
JNIEXPORT jdouble JNICALL Java_com_realm_Table_nativeAverageDouble(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Double))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeMaximumDate(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeMinimumDate(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_DateTime))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeCountLong(
    JNIEnv *env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong value)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Int))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeCountFloat(
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeCountDouble(
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeCountString(
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeLookup(
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeWhere(
    JNIEnv *env, jobject, jlong nativeTablePtr)
{
    if (!TABLE_VALID(env, TBL(nativeTablePtr)))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeFindFirstInt(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong value)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Int))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeFindFirstBool(
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeFindFirstFloat(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jfloat value)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Float))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeFindFirstDouble(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jdouble value)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Double))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeFindFirstDate(
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeFindFirstString(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jstring value)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_String))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeFindAllInt(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong value)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Int))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeFindAllFloat(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jfloat value)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Float))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeFindAllDouble(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jdouble value)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Double))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeFindAllBool(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jboolean value)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Bool))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeFindAllDate(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong dateTimeValue)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_DateTime))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeFindAllString(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jstring value)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_String))
        return 0;
...
// experimental
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeLowerBoundInt(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong value)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Int))
        return 0;
...
// experimental
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeUpperBoundInt(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong value)
{
    if (!TBL_AND_COL_INDEX_AND_TYPE_VALID(env, TBL(nativeTablePtr), columnIndex, type_Int))
        return 0;
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeGetDistinctView(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex)
{
    Table* pTable = TBL(nativeTablePtr);
    if (!TBL_AND_COL_INDEX_VALID(env, pTable, columnIndex))
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_nativeGetSortedView(
...
JNIEXPORT void JNICALL Java_com_realm_Table_nativeOptimize(
    JNIEnv* env, jobject, jlong nativeTablePtr)
{
    if (!TABLE_VALID(env, TBL(nativeTablePtr)))
        return;
...
JNIEXPORT jstring JNICALL Java_com_realm_Table_nativeToJson(
    JNIEnv *env, jobject, jlong nativeTablePtr)
{
...
JNIEXPORT jstring JNICALL Java_com_realm_Table_nativeToString(
...
JNIEXPORT jstring JNICALL Java_com_realm_Table_nativeRowToString(
    JNIEnv *env, jobject, jlong nativeTablePtr, jlong rowIndex)
{
    Table* table = TBL(nativeTablePtr);
...
JNIEXPORT jboolean JNICALL Java_com_realm_Table_nativeEquals(
...
JNIEXPORT jboolean JNICALL Java_com_realm_Table_nativeIsValid(
    JNIEnv*, jobject, jlong nativeTablePtr)
{
    return TBL(nativeTablePtr)->is_attached();  // noexcept
}

JNIEXPORT void JNICALL Java_com_realm_Table_nativeClose(
...
JNIEXPORT jlong JNICALL Java_com_realm_Table_createNative(JNIEnv* env, jobject jTable)
{
