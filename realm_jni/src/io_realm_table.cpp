...
/*
JNIEXPORT jobject JNICALL Java_io_realm_Table_nativeGetByteBuffer(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex)
{
...
/*
JNIEXPORT void JNICALL Java_io_realm_Table_nativeSetByteBuffer(
...
*/
/*
JNIEXPORT void JNICALL Java_io_realm_Table_nativeInsertByteBuffer(
    JNIEnv* env, jobject, jlong nativeTablePtr, jlong columnIndex, jlong rowIndex, jobject byteBuffer)
{
