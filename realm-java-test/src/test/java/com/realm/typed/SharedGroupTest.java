...
import com.realm.SharedGroup.Durability;
...
public class SharedGroupTest {
    ...
    public void testExistingLockFileWithDeletedDb() {
        ...
        if(new File(uniqueName + ".lock").exists()) {
            ...
            try { SharedGroup sg2 = new SharedGroup(uniqueName); fail("The database file is missing, but a .lock file is present."); } catch(com.realm.IOException e) { }
        }
    }
