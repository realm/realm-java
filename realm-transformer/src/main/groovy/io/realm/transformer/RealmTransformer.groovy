...
class RealmTransformer extends Transform {
    ...
    void transform(Context context, Collection<TransformInput> inputs, Collection<TransformInput> referencedInputs,
        ...
        def allModelClasses = findModelClasses(classPool, isIncremental, allClassNames);
    ...
    private Collection<CtClass> findModelClasses(ClassPool classPool, boolean isIncrementalBuild, Set<String> allClassNames) {
        ...
        if (isIncrementalBuild) {
            ...
            return allClassNames
                ...
                .findResults {
                    ...
                    def clazz = classPool.getCtClass(it)
     ...
     * @return {@code true} if {@code clazz} is a subtype of {@code typeToCheckAgainst}, {@code false} otherwise.
     */
