...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void*)
{
    ...
    if (vm->GetEnv((void **) &env, JNI_VERSION_1_6) != JNI_OK) {
        ...
        // FIXME Move this to own library
        ...
        sync_manager_notify_error_handler = env->GetStaticMethodID(sync_manager, "notifyErrorHandler", "(ILjava/lang/String;)V");
        session_class_ref     = GetClass(env, "io/realm/objectserver/session/Session");
        session_error_handler = env->GetMethodID(session_class_ref, "notifySessionError", "(ILjava/lang/String;)V");
    }
