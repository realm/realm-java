...
class DefaultRealmModuleMediator extends RealmProxyMediator {
    ...
    @Override
    public void insertToRealm(Realm realm, RealmModel type) {
        // This cast is correct because obj is either
        // generated by RealmProxy or the original type extending directly from RealmObject
        ...
        if (clazz.equals(AllTypes.class)) {
            AllTypesRealmProxy.insert(realm, (AllTypes) type, new IdentityHashMap<RealmModel, Long>());
        } else {
            throw getMissingProxyClassException(clazz);
        }
    }
    ...
    @Override
    public void insertToRealm(Realm realm, RealmModel type, Iterator<? extends RealmModel> objects) {
        // This cast is correct because obj is either
        // generated by RealmProxy or the original type extending directly from RealmObject
        @SuppressWarnings("unchecked") Class<RealmModel> clazz = (Class<RealmModel>) ((type instanceof RealmObjectProxy) ? type.getClass().getSuperclass() : type.getClass());
        ...
        if (clazz.equals(AllTypes.class)) {
            AllTypesRealmProxy.insert(realm, objects, cache);
        } else {
            throw getMissingProxyClassException(clazz);
        }
    }
    ...
    @Override
    public void insertOrUpdateToRealm(Realm realm, RealmModel obj) {
        // This cast is correct because obj is either
        // generated by RealmProxy or the original type extending directly from RealmObject
        @SuppressWarnings("unchecked") Class<RealmModel> clazz = (Class<RealmModel>) ((obj instanceof RealmObjectProxy) ? obj.getClass().getSuperclass() : obj.getClass());

        if (clazz.equals(AllTypes.class)) {
            AllTypesRealmProxy.insertOrUpdate(realm, (AllTypes) obj, new IdentityHashMap<RealmModel, Long>());
        } else {
            throw getMissingProxyClassException(clazz);
        }
    }
    ...
    public void insertOrUpdateToRealm(Realm realm, RealmModel type, Iterator<? extends RealmModel> objects) {
        ...
        if (clazz.equals(AllTypes.class)) {
            AllTypesRealmProxy.insertOrUpdate(realm, objects, cache);
        } else {
            throw getMissingProxyClassException(clazz);
        }
    }
