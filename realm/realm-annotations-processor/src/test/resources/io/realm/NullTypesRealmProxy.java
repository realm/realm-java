...
public class NullTypesRealmProxy extends some.test.NullTypes
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        ...
        builder.addPersistedLinkProperty("fieldObjectNull", RealmFieldType.OBJECT, "NullTypes", !Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldStringListNotNull", RealmFieldType.STRING_LIST, "", Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldStringListNull", RealmFieldType.STRING_LIST, "", !Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldBinaryListNotNull", RealmFieldType.BINARY_LIST, "", Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldBinaryListNull", RealmFieldType.BINARY_LIST, "", !Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldBooleanListNotNull", RealmFieldType.BOOLEAN_LIST, "", Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldBooleanListNull", RealmFieldType.BOOLEAN_LIST, "", !Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldLongListNotNull", RealmFieldType.INTEGER_LIST, "", Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldLongListNull", RealmFieldType.INTEGER_LIST, "", !Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldIntegerListNotNull", RealmFieldType.INTEGER_LIST, "", Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldIntegerListNull", RealmFieldType.INTEGER_LIST, "", !Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldShortListNotNull", RealmFieldType.INTEGER_LIST, "", Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldShortListNull", RealmFieldType.INTEGER_LIST, "", !Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldByteListNotNull", RealmFieldType.INTEGER_LIST, "", Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldByteListNull", RealmFieldType.INTEGER_LIST, "", !Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldDoubleListNotNull", RealmFieldType.DOUBLE_LIST, "", Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldDoubleListNull", RealmFieldType.DOUBLE_LIST, "", !Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldFloatListNotNull", RealmFieldType.FLOAT_LIST, "", Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldFloatListNull", RealmFieldType.FLOAT_LIST, "", !Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldDateListNotNull", RealmFieldType.DATE_LIST, "", Property.REQUIRED);
        builder.addPersistedLinkProperty("fieldDateListNull", RealmFieldType.DATE_LIST, "", !Property.REQUIRED);
