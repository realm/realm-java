...
public class NullTypesRealmProxy extends some.test.NullTypes
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        ...
        builder.addPersistedLinkProperty("fieldStringListNotNull", RealmFieldType.STRING_LIST, "");
        builder.addPersistedLinkProperty("fieldStringListNull", RealmFieldType.STRING_LIST, "");
        builder.addPersistedLinkProperty("fieldBinaryListNotNull", RealmFieldType.BINARY_LIST, "");
        builder.addPersistedLinkProperty("fieldBinaryListNull", RealmFieldType.BINARY_LIST, "");
        builder.addPersistedLinkProperty("fieldBooleanListNotNull", RealmFieldType.BOOLEAN_LIST, "");
        builder.addPersistedLinkProperty("fieldBooleanListNull", RealmFieldType.BOOLEAN_LIST, "");
        builder.addPersistedLinkProperty("fieldLongListNotNull", RealmFieldType.INTEGER_LIST, "");
        builder.addPersistedLinkProperty("fieldLongListNull", RealmFieldType.INTEGER_LIST, "");
        builder.addPersistedLinkProperty("fieldIntegerListNotNull", RealmFieldType.INTEGER_LIST, "");
        builder.addPersistedLinkProperty("fieldIntegerListNull", RealmFieldType.INTEGER_LIST, "");
        builder.addPersistedLinkProperty("fieldShortListNotNull", RealmFieldType.INTEGER_LIST, "");
        builder.addPersistedLinkProperty("fieldShortListNull", RealmFieldType.INTEGER_LIST, "");
        builder.addPersistedLinkProperty("fieldByteListNotNull", RealmFieldType.INTEGER_LIST, "");
        builder.addPersistedLinkProperty("fieldByteListNull", RealmFieldType.INTEGER_LIST, "");
        builder.addPersistedLinkProperty("fieldDoubleListNotNull", RealmFieldType.DOUBLE_LIST, "");
        builder.addPersistedLinkProperty("fieldDoubleListNull", RealmFieldType.DOUBLE_LIST, "");
        builder.addPersistedLinkProperty("fieldFloatListNotNull", RealmFieldType.FLOAT_LIST, "");
        builder.addPersistedLinkProperty("fieldFloatListNull", RealmFieldType.FLOAT_LIST, "");
        builder.addPersistedLinkProperty("fieldDateListNotNull", RealmFieldType.DATE_LIST, "");
        builder.addPersistedLinkProperty("fieldDateListNull", RealmFieldType.DATE_LIST, "");
