...
public class some_test_EmbeddedClassSimpleParentRealmProxy extends some.test.EmbeddedClassSimpleParent
    ...
    public void realmSet$child(some.test.EmbeddedClass value) {
        ...
        proxyState.checkValidObject(value);
        proxyState.getRow$realm().setLink(columnInfo.childColKey, ((RealmObjectProxy) value).realmGet$proxyState().getRow$realm().getObjectKey());
    }
    ...
    public static some.test.EmbeddedClassSimpleParent copy(Realm realm, EmbeddedClassSimpleParentColumnInfo columnInfo, some.test.EmbeddedClassSimpleParent newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (childObj == null) {
            ...
            if (cachechild != null) {
                ...
                realmObjectCopy.realmSet$child(some_test_EmbeddedClassRealmProxy.copyOrUpdate(realm, (some_test_EmbeddedClassRealmProxy.EmbeddedClassColumnInfo) realm.getSchema().getColumnInfo(some.test.EmbeddedClass.class), childObj, update, cache, flags));
            }
        }

        RealmList<some.test.EmbeddedClass> childrenList = realmObjectSource.realmGet$children();
        if (childrenList != null) {
            RealmList<some.test.EmbeddedClass> childrenRealmList = realmObjectCopy.realmGet$children();
            childrenRealmList.clear();
            for (int i = 0; i < childrenList.size(); i++) {
                some.test.EmbeddedClass childrenItem = childrenList.get(i);
                some.test.EmbeddedClass cachechildren = (some.test.EmbeddedClass) cache.get(childrenItem);
                if (cachechildren != null) {
                    childrenRealmList.add(cachechildren);
                } else {
                    childrenRealmList.add(some_test_EmbeddedClassRealmProxy.copyOrUpdate(realm, (some_test_EmbeddedClassRealmProxy.EmbeddedClassColumnInfo) realm.getSchema().getColumnInfo(some.test.EmbeddedClass.class), childrenItem, update, cache, flags));
                }
            }
        }
    ...
    public static long insert(Realm realm, some.test.EmbeddedClassSimpleParent object, Map<RealmModel,Long> cache) {
        ...
        if (childObj != null) {
            ...
            if (cachechild == null) {
                cachechild = some_test_EmbeddedClassRealmProxy.insert(realm, childObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.childColKey, objKey, cachechild, false);
        }
        ...
        if (childrenList != null) {
            ...
            for (some.test.EmbeddedClass childrenItem : childrenList) {
                ...
                if (cacheItemIndexchildren == null) {
                    cacheItemIndexchildren = some_test_EmbeddedClassRealmProxy.insert(realm, childrenItem, cache);
                }
                childrenOsList.addRow(cacheItemIndexchildren);
            }
        }
        return objKey;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        while (objects.hasNext()) {
            ...
            if (childObj != null) {
                ...
                table.setLink(columnInfo.childColKey, objKey, cachechild, false);
            }
    ...
    public static long insertOrUpdate(Realm realm, some.test.EmbeddedClassSimpleParent object, Map<RealmModel,Long> cache) {
        ...
        if (childObj != null) {
            Long cachechild = cache.get(childObj);
            if (cachechild == null) {
                cachechild = some_test_EmbeddedClassRealmProxy.insertOrUpdate(realm, childObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.childColKey, objKey, cachechild, false);
        } else {
        ...
        if (childrenList != null && childrenList.size() == childrenOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexchildren = cache.get(childrenItem);
                if (cacheItemIndexchildren == null) {
                    cacheItemIndexchildren = some_test_EmbeddedClassRealmProxy.insertOrUpdate(realm, childrenItem, cache);
                }
                childrenOsList.setRow(i, cacheItemIndexchildren);
            }
        } else {
    ...
    static some.test.EmbeddedClassSimpleParent update(Realm realm, EmbeddedClassSimpleParentColumnInfo columnInfo, some.test.EmbeddedClassSimpleParent realmObject, some.test.EmbeddedClassSimpleParent newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (childObj == null) {
            ...
            some_test_EmbeddedClassRealmProxy.update(realm, (some_test_EmbeddedClassRealmProxy.EmbeddedClassColumnInfo) realm.getSchema().getColumnInfo(some.test.EmbeddedClass.class), proxyObject, childObj, cache, flags);
        }
        ...
        if (childrenList != null) {
            ...
            for (int i = 0; i < childrenList.size(); i++) {
                ...
                some.test.EmbeddedClass cachechildren = (some.test.EmbeddedClass) cache.get(childrenItem);
                if (cachechildren != null) {
                    childrenManagedCopy.add(cachechildren);
                } else {
                    childrenManagedCopy.add(some_test_EmbeddedClassRealmProxy.copyOrUpdate(realm, (some_test_EmbeddedClassRealmProxy.EmbeddedClassColumnInfo) realm.getSchema().getColumnInfo(some.test.EmbeddedClass.class), childrenItem, true, cache, flags));
                }
            }
