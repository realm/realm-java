...
public class RealmProxyMediatorGenerator {
    ...
    private void emitInsertObjectToRealmMethod(JavaWriter writer) throws IOException {
        ...
        writer.beginMethod(
                ...
                "insertToRealm",
                EnumSet.of(Modifier.PUBLIC),
                "Realm", "realm", "RealmModel", "type");
        writer.emitSingleLineComment("This cast is correct because obj is either");
        writer.emitSingleLineComment("generated by RealmProxy or the original type extending directly from RealmObject");
        writer.emitStatement("@SuppressWarnings(\"unchecked\") Class<RealmModel> clazz = (Class<RealmModel>) ((type instanceof RealmObjectProxy) ? type.getClass().getSuperclass() : type.getClass())");
        writer.emitEmptyLine();
        emitMediatorSwitch(new ProxySwitchStatement() {
            @Override
            public void emitStatement(int i, JavaWriter writer) throws IOException {
                writer.emitStatement("%s.insert(realm, (%s) type, new IdentityHashMap<RealmModel, Long>())", proxyClasses.get(i), simpleModelClasses.get(i));
            }
        }, writer, false);
        writer.endMethod();
        writer.emitEmptyLine();
    ...
    private void emitInsertOrUpdateObjectToRealmMethod(JavaWriter writer) throws IOException {
        ...
        writer.beginMethod(
                "void",
                "insertOrUpdateToRealm",
                EnumSet.of(Modifier.PUBLIC),
                "Realm", "realm", "RealmModel", "obj");
        writer.emitSingleLineComment("This cast is correct because obj is either");
        writer.emitSingleLineComment("generated by RealmProxy or the original type extending directly from RealmObject");
        ...
        emitMediatorSwitch(new ProxySwitchStatement() {
            @Override
            public void emitStatement(int i, JavaWriter writer) throws IOException {
                writer.emitStatement("%s.insertOrUpdate(realm, (%s) obj, new IdentityHashMap<RealmModel, Long>())", proxyClasses.get(i), simpleModelClasses.get(i));
            }
        }, writer, false);
        writer.endMethod();
        writer.emitEmptyLine();
    ...
    private void emitInsertOrUpdateListToRealmMethod(JavaWriter writer) throws IOException {
        ...
        writer.beginMethod(
                ...
                "insertOrUpdateToRealm",
                EnumSet.of(Modifier.PUBLIC),
                "Realm", "realm", "RealmModel", "type", "Iterator<? extends RealmModel>", "objects", "int", "size");

        writer.emitSingleLineComment("This cast is correct because obj is either");
        writer.emitSingleLineComment("generated by RealmProxy or the original type extending directly from RealmObject");
        writer.emitStatement("@SuppressWarnings(\"unchecked\") Class<RealmModel> clazz = (Class<RealmModel>) ((type instanceof RealmObjectProxy) ? type.getClass().getSuperclass() : type.getClass())");
        writer.emitStatement("Map<RealmModel, Long> cache = new IdentityHashMap<RealmModel, Long>(size)");
        writer.emitEmptyLine();

        emitMediatorSwitch(new ProxySwitchStatement() {
            @Override
            public void emitStatement(int i, JavaWriter writer) throws IOException {
                        writer.emitStatement("%s.insertOrUpdate(realm, objects, cache)", proxyClasses.get(i));
            }
        }, writer, false);
        writer.endMethod();
        writer.emitEmptyLine();
    ...
    private void emitInsertListToRealmMethod(JavaWriter writer) throws IOException {
        ...
        emitMediatorSwitch(new ProxySwitchStatement() {
            @Override
            public void emitStatement(int i, JavaWriter writer) throws IOException {
                writer.emitStatement("%s.insert(realm, objects, cache)", proxyClasses.get(i));
            }
        }, writer, false);
        writer.endMethod();
        writer.emitEmptyLine();
