...
// *     Call {@link #start()} to start synchronizing changes.
// * </li>
// * <li>
// *     <b>BINDING</b> A session is in the process of binding a local Realm to a remote one. Calling {@link #stop()}
...
//
//    private String localRealmPath;
//    private boolean nativeSessionCreated = false;
//
...
//
//    /**
//     * The lifecycle of the native `SyncSession` is handled by the Object Store.
//     * This means that the native SyncSession is not available when this class is created and
//     * it must be added later.
//     *
//     * This Java instance must outlive the Object Store SyncSession as the native SyncSession
//     * will try to callback to this class for if required (e.g. error handling).
//     *
//     * It is a logical error to try to call native methods before this method has been called.
//     *
//     * @see #notifySessionError(int, String)
//     */
//    public void setNativeSessionPointer(String localRealmPath) {
//        this.localRealmPath = localRealmPath;
...
//
//    /**
//     * Starts the session. This will cause the session to come <b>UNBOUND</b>. {@link #start()} must be called to
//     * actually start synchronizing data.
//     */
//    public synchronized void start() {
//        nativeStartSession(localRealmPath);
//    }
//
//    /**
...
//        nativeStopSession(localRealmPath);
//    }
//
////    /**
...
//    }
//
//    private native long nativeGetSession(String localRealmPath, long nativeConfigWrapperPointer);
...
//    private native void nativeStartSession(String localRealmPath);
//    private native void nativeStopSession(String localRealmPath);
