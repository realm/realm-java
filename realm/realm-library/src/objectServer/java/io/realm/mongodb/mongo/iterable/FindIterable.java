...
public class FindIterable<ResultT> {
     ...
     * @return this
     */
    FindIterable<ResultT> filter(@Nullable final Bson filter) {
     ...
     * @return this
     */
    FindIterable<ResultT> limit(final int limit) {
        throw new RuntimeException("Not Implemented");
    }
     ...
     * @return this
     */
    FindIterable<ResultT> projection(@Nullable final Bson projection) {
        throw new RuntimeException("Not Implemented");
    }
     ...
     * @return this
     */
    FindIterable<ResultT> sort(@Nullable final Bson sort) {
        throw new RuntimeException("Not Implemented");
    }
}
