 ...
 *     saved in a {@link RealmAppCredentials} object of the proper type e.g., {@link RealmAppCredentials#facebook(String)} for a
 *     Facebook login.
 * </li>
 * <li>
 *     Authenticate a {@link RealmAppUser} through the Object Server using these credentials. Once authenticated,
 ...
 * </pre>
 */
public class RealmAppCredentials {
    ...
    public static RealmAppCredentials facebook(String facebookToken) {
        ...
        return new RealmAppCredentials(facebookToken, IdentityProvider.FACEBOOK, null);
    }
    ...
    public static RealmAppCredentials google(String googleToken) {
        ...
        return new RealmAppCredentials(googleToken, IdentityProvider.GOOGLE, null);
    }
    ...
    public static RealmAppCredentials jwt(String jwtToken) {
        ...
        return new RealmAppCredentials(jwtToken, IdentityProvider.JWT, null);
    }
    ...
    public static RealmAppCredentials usernamePassword(String username, String password, boolean createUser) {
        ...
        return new RealmAppCredentials(username, IdentityProvider.USERNAME_PASSWORD, userInfo);
    }
    ...
    public static RealmAppCredentials custom(String userIdentifier, String identityProvider, @Nullable Map<String, Object> userInfo) {
        ...
        return new RealmAppCredentials(userIdentifier, identityProvider, userInfo);
    }
    ...
    public static RealmAppCredentials accessToken(String accessToken, String identifier, boolean isAdmin) {
        ...
        return new RealmAppCredentials(identifier, IdentityProvider.ACCESS_TOKEN, userInfo);
    }
    ...
    private RealmAppCredentials(String token, String identityProvider, @Nullable Map<String, Object> userInfo) {
     ...
     * The type of information will depend on the type of {@link RealmAppCredentials.IdentityProvider}
     * used.
     *
