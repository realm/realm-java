    ...
    try {
        ...
        switch(j_function_type) {
            ...
            case io_realm_mongodb_EmailPasswordAuthImpl_TYPE_RESET_PASSWORD:
                ...
                break;
            case io_realm_mongodb_EmailPasswordAuthImpl_TYPE_CALL_CUSTOM_CONFIRMATION_FUNCTION:
                client.call_custom_confirmation_function(args[0], JavaNetworkTransport::create_void_callback(env, j_callback));
                break;
            default:
