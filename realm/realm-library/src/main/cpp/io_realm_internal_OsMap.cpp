...
Java_io_realm_internal_OsMap_nativeClose(JNIEnv*, jclass, jlong native_ptr) {
    DictionaryWrapper* wrapper = reinterpret_cast<DictionaryWrapper*>(native_ptr);
    delete wrapper;
}
...
Java_io_realm_internal_OsMap_nativeGetValue(JNIEnv* env, jclass, jlong wrapper_ptr,
                                            jstring j_key) {
    try {
        auto& wrapper = *reinterpret_cast<DictionaryWrapper*>(wrapper_ptr);
...
//    try {
//        // TODO: use list approach here
////        auto wrapper = reinterpret_cast<ListWrapper*>(native_ptr);
////        wrapper->start_listening(env, instance);
//
//        auto& dictionary = *reinterpret_cast<realm::object_store::Dictionary*>(wrapper_ptr);
//
//    }
//    CATCH_STD()
//}
...
//
//JNIEXPORT void JNICALL
//Java_io_realm_internal_OsMap_nativeStartListening(JNIEnv* env, jclass, jlong map_ptr) {
//    try {
//        // TODO: use list approach here
////        auto wrapper = reinterpret_cast<ListWrapper*>(native_ptr);
////        wrapper->start_listening(env, instance);
