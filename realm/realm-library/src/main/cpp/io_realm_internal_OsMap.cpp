...
JNIEXPORT void JNICALL
Java_io_realm_internal_OsMap_nativeStartListening(JNIEnv* env, jobject instance, jlong wrapper_ptr) {
    try {
        auto wrapper = reinterpret_cast<ObservableDictionaryWrapper*>(wrapper_ptr);
...
JNIEXPORT void JNICALL
Java_io_realm_internal_OsMap_nativeStopListening(JNIEnv* env, jobject, jlong wrapper_ptr) {
    try {
        auto wrapper = reinterpret_cast<ObservableDictionaryWrapper*>(wrapper_ptr);
...
//        std::shared_ptr<Realm>& shared_realm_ptr = *reinterpret_cast<std::shared_ptr<Realm>*>(realm_ptr);
//        object_store::Dictionary frozen_dictionary = dictionary.freeze(shared_realm_ptr);
//        return reinterpret_cast<jlong>(new DictionaryWrapper(frozen_dictionary));
//    }
//    CATCH_STD()
//    return reinterpret_cast<jlong>(nullptr);
//}
