...
JNIEXPORT void JNICALL Java_io_realm_SyncSession_nativeWaitForDownloadCompletion(JNIEnv* env,
...
JNIEXPORT void JNICALL Java_io_realm_SyncSession_nativeWaitForUploadCompletion(JNIEnv* env,
                                                                                   jobject session_object,
                                                                                   jint callback_id,
                                                                                   jstring j_local_realm_path)
{
