...
// We need to control the life cycle of Results, weak ref of Java OsResults object and the NotificationToken.
// Wrap all three together, so when the Java OsResults object gets GCed, all three of them will be invalidated.
...
JNIEXPORT jlong JNICALL Java_io_realm_internal_OsResults_nativeCreateResultsFromLinkView(JNIEnv* env, jclass,
...
JNIEXPORT jlong JNICALL Java_io_realm_internal_OsResults_nativeIndexOfBySourceRowIndex(JNIEnv* env, jclass,
                                                                                        jlong native_ptr,
