...
public final class Realm extends BaseRealm {
    ...
    public RealmAsyncTask executeTransactionAsync(final Transaction transaction, final Realm.Transaction.OnSuccess onSuccess, final Realm.Transaction.OnError onError) {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (handler != null
                        ...
                        if (!handlerController.threadContainsAsyncQueries() && !asyncTransactionCallbacks.isEmpty()) {
                            for (Runnable transactionCallback : asyncTransactionCallbacks) {
                                handler.post(transactionCallback);
                            }
        ...
        tidyPerformedTransactions();
        asyncTransactions.add(pendingQuery);
