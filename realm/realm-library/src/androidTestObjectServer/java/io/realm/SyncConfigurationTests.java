...
////        for (RealmUser syncUser : userStore.allUsers()) {
...
//        RealmUser user = createTestUser(0); // Create user that has expired credentials
//        try {
...
//            RealmUser user = (RealmUser) test[0];
...
//        RealmUser user1 = createNamedTestUser("user1");
//        RealmUser user2 = createNamedTestUser("user2");
...
//
//            RealmUser user = createTestUser(authUrl);
