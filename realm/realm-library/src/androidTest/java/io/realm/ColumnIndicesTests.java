...
public class ColumnIndicesTests {
    ...
    private ColumnIndices create(long schemaVersion) {
        ...
        catColumnInfo = (CatRealmProxy.CatColumnInfo) mediator.validateTable(mediator, Cat.class, realm.sharedRealm, false);
        dogColumnInfo = (DogRealmProxy.DogColumnInfo) mediator.validateTable(mediator, Dog.class, realm.sharedRealm, false);
