...
public class ColumnIndicesTests {
    ...
    private ColumnIndices create(long schemaVersion) {
        ...
        catColumnInfo = (CatRealmProxy.CatColumnInfo) mediator.validateTable(Cat.class, realm.osSharedRealm, false);
        dogColumnInfo = (DogRealmProxy.DogColumnInfo) mediator.validateTable(Dog.class, realm.osSharedRealm, false);
