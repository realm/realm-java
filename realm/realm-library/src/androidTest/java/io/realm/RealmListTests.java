...
public class RealmListTests extends CollectionTests {
    ...
    public void toString_managedMode() {
        ...
        for (int i = 0; i < collection.size() - 1; i++) {
            sb.append(((RealmObjectProxy) (collection.get(i))).realmGet$proxyState().getRow$realm().getColumnKey());
            sb.append(",");
        }
        sb.append(((RealmObjectProxy)collection.get(TEST_SIZE - 1)).realmGet$proxyState().getRow$realm().getColumnKey());
        sb.append("]");
