...
public class RealmResultsTests {
     ...
     * the outcome is different if the order of distinct* operations alternates.
     * An example is illustrated below.
     *
     * Object        : O1| O2| O3| O4| O5| O6
     * indexedString : A | A | B | B | A | A
     * indexedLong   : 1 | 1 | 1 | 2 | 2 | 2
     *
     * Suppose we're to execute distinct("indexedString").distinct("indexedLong"), the outcome
     * should be O1(A, 1) and total count is 1 since distinct takes the first element when two
     * elements are identical.
     *
     * In case of distinct("indexedLong").distinct("indexedString"), the outcome should be
     * O1(A,1) and O2(B,2) so total count is 2.
     *
     */
    private void populateForChainedOperation(Realm realm, long numberOfBlocks) {
        realm.beginTransaction();
    ...
    public void distinct_checkChainedOpertionValidity() {
        ...
        populateForChainedOperation(realm, numberOfBlocks);
