...
public class ColumnInfoTests {
    ...
    public void copyColumnInfoFrom_checkIndex() {
        ...
        sourceColumnInfo = (CatRealmProxy.CatColumnInfo) mediator.validateTable(mediator, Cat.class, realm.sharedRealm, false);
        targetColumnInfo = (CatRealmProxy.CatColumnInfo) mediator.validateTable(mediator, Cat.class, realm.sharedRealm, false);
    ...
    public void clone_hasSameValue() {
        ...
        columnInfo = (CatRealmProxy.CatColumnInfo) mediator.validateTable(mediator, Cat.class, realm.sharedRealm, false);
