...
class ManagedDictionaryTester<T : Any>(
        ...
        private val requiredDictionarySetter: KFunction2<AllTypes, RealmDictionary<T>, Unit>? = null
) : DictionaryTester {
    ...
    override fun putRequired() = assertManagedPutRequired(realm, requiredDictionaryGetter, initializedDictionary, alternativeDictionary)
...
fun managedFactory(): List<DictionaryTester> {
    val primitiveTesters = listOf<DictionaryTester>(
            ManagedDictionaryTester(
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredLongDictionary
            ),
            ManagedDictionaryTester(
                    testerClass = "Integer",
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredIntegerDictionary
            ),
            ManagedDictionaryTester(
                    testerClass = "Short",
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredShortDictionary
            ),
            ManagedDictionaryTester(
                    testerClass = "Byte",
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredByteDictionary
            ),
            ManagedDictionaryTester(
                    testerClass = "Float",
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredFloatDictionary
            ),
            ManagedDictionaryTester(
                    testerClass = "Double",
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredDoubleDictionary
            ),
            ManagedDictionaryTester(
                    testerClass = "String",
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredStringDictionary
            ),
            ManagedDictionaryTester(
                    testerClass = "Boolean",
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredBooleanDictionary
            ),
            ManagedDictionaryTester(
                    testerClass = "Date",
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredDateDictionary
            ),
            ManagedDictionaryTester(
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredDecimal128Dictionary
            ),
            ManagedDictionaryTester(
                    ...
                    requiredDictionaryGetter = AllTypes::getColumnRequiredBoxedBinaryDictionary,
                    requiredDictionarySetter = AllTypes::setColumnRequiredBoxedBinaryDictionary
            ),
            ManagedDictionaryTester(
                    testerClass = "Binary",
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredBinaryDictionary
            ),
            ManagedDictionaryTester(
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredObjectIdDictionary
            ),
            ManagedDictionaryTester(
                    testerClass = "UUID",
                    ...
                    requiredDictionarySetter = AllTypes::setColumnRequiredUUIDDictionary
            ),
            ManagedDictionaryTester(
                    // No required getters and setters for RealmModels
                    testerClass = "Link",
    ...
    val mixedTesters = MixedType.values().map { mixedType ->
        ManagedDictionaryTester(
                // No required getters and setters for Mixed
...
private fun <T : Any> assertManagedSize(
        realm: Realm,
...
private fun <T : Any> assertManagedIsEmpty(
        realm: Realm,
        dictionaryGetter: KFunction1<AllTypes, RealmDictionary<T>>,
        initializedDictionary: RealmDictionary<T>
) {
...
private fun <T : Any> assertManagedContainsKey(
        realm: Realm,
        dictionaryGetter: KFunction1<AllTypes, RealmDictionary<T>>,
        initializedDictionary: RealmDictionary<T>
) {
...
private fun <T : Any> assertManagedContainsValue(
        realm: Realm,
        dictionaryGetter: KFunction1<AllTypes, RealmDictionary<T>>,
        initializedDictionary: RealmDictionary<T>
) {
    ...
    initializedDictionary.values.forEachIndexed { index, value ->
        if (value is DogPrimaryKey) {
            ...
            realm.executeTransaction { transactionRealm ->
                ...
                assertFalse(dictionary.containsValue(dummyRealmModel as T))
            }
            ...
            if (value.valueClass == DogPrimaryKey::class.java) {
                realm.executeTransaction { transactionRealm ->
                    ...
                    assertFalse(dictionary.containsValue(mixedWithManagedModel as T))
                }
            } else {
...
private fun <T : Any> assertManagedGet(
        realm: Realm,
        dictionaryGetter: KFunction1<AllTypes, RealmDictionary<T>>,
        initializedDictionary: RealmDictionary<T>
) {
...
private fun <T : Any> assertManagedPut(
        realm: Realm,
        dictionaryGetter: KFunction1<AllTypes, RealmDictionary<T>>,
        initializedDictionary: RealmDictionary<T>,
...
private fun <T : Any> assertManagedPutAll(
        realm: Realm,
        dictionaryGetter: KFunction1<AllTypes, RealmDictionary<T>>,
        initializedDictionary: RealmDictionary<T>
) {
...
private fun <T : Any> assertManagedClear(
        realm: Realm,
        dictionaryGetter: KFunction1<AllTypes, RealmDictionary<T>>,
        initializedDictionary: RealmDictionary<T>
) {
...
private fun <T : Any> assertManagedKeySet(
        realm: Realm,
        dictionaryGetter: KFunction1<AllTypes, RealmDictionary<T>>,
        initializedDictionary: RealmDictionary<T>
) {
...
private fun <T : Any> assertManagedValues(
        realm: Realm,
        dictionaryGetter: KFunction1<AllTypes, RealmDictionary<T>>,
        initializedDictionary: RealmDictionary<T>
) {
...
private fun <T : Any> assertManagedEntrySet(
        realm: Realm,
        dictionaryGetter: KFunction1<AllTypes, RealmDictionary<T>>,
        initializedDictionary: RealmDictionary<T>,
        alternativeDictionary: RealmDictionary<T>
    ...
    realm.executeTransaction {
        ...
        when (entrySet.first().value) {
            ...
            is Mixed -> {
                val sameCollection =
                        dictionary.map { entry: Map.Entry<String, T?> ->
                        ...
                        }.toSet() as Set<Map.Entry<String, T>>
...
private fun <T : Any> assertCopyToRealm(
        realm: Realm,
        dictionaryGetter: KFunction1<AllTypes, RealmDictionary<T>>,
        dictionarySetter: KFunction2<AllTypes, RealmDictionary<T>, Unit>,
        initializedDictionary: RealmDictionary<T>
) {
...
private fun <T : Any> assertCopyFromRealm(
        realm: Realm,
        dictionaryGetter: KFunction1<AllTypes, RealmDictionary<T>>,
        initializedDictionary: RealmDictionary<T>
) {
...
private fun <T> assertEqualsHelper(realm: Realm, value: T?, valueFromRealm: T?) {
    when (valueFromRealm) {
        ...
        is Mixed -> when {
            ...
            else -> assertEquals(value as T, valueFromRealm)
        }
        else -> assertEquals(value, valueFromRealm)
    }
}

private fun <T : Any> assertContainsValue(
        realm: Realm,
        key: String,
        value: T?,
    ...
    when (value) {
        is DogPrimaryKey -> {
            ...
            val managedRealmModel = realm.where<DogPrimaryKey>()
                    ...
                    .findFirst()
            assertTrue(managedDictionary.containsValue(managedRealmModel as T))
        }
        is Mixed -> when {
            // If null, check we have "Mixed.nullValue()"
            value.isNull -> assertTrue(managedDictionary.containsValue(Mixed.nullValue() as T))
            value.valueClass == DogPrimaryKey::class.java -> {
                ...
                assertTrue(managedDictionary.containsValue(mixedWithManagedDog as T))
            }
