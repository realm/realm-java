...
public class Constants {
    ...
    public static String SYNC_SERVER_URL = "realm://" + HttpUtils.TEST_SERVER_IP + ":7800/tests";
    public static String SYNC_SERVER_URL_2 = "realm://" + HttpUtils.TEST_SERVER_IP + ":7800/tests2";

    public static String AUTH_SERVER_URL = "http://" + HttpUtils.TEST_SERVER_IP + ":8080/";
