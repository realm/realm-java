...
public final class EmployeesFixture {
    ...
    public static final EmployeeData[] EMPLOYEES = {new EmployeeData("John", "Doe", 10000, true, new byte[] {1, 2,
            3}, new Date(111111), "extra", PHONES[0]),
