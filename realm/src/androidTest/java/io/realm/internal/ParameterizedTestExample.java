...
public class ParameterizedTestExample extends TestCase {
    ...
    public ParameterizedTestExample(int input_one, int input_two, int expected_value) {
    ...
    public static Test suite() {
        return new RealmTestSuite(ParameterizedTestExample.class, parameters());
