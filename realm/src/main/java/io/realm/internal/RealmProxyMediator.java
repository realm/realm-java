...
public abstract class RealmProxyMediator {
    ...
    /**
     * Copy a non-manged RealmObject or a RealmObject from another Realm to this Realm. After being copied any changes
     * to the original object will not be persisted.
     *
     ...
     */
    public abstract <E extends RealmObject> E copyOrUpdate(Realm realm, E object, boolean update, Map<RealmObject,
     ...
     * @param update True if Realm should try to update a existing object. This requires that the model has a
     * @PrimaryKey
     ...
     */
    public abstract <E extends RealmObject> E createOrUpdateUsingJsonObject(Class<E> clazz, Realm realm, JSONObject
            json, boolean update) throws JSONException;
     ...
     */
    public abstract <E extends RealmObject> E createUsingJsonStream(Class<E> clazz, Realm realm, JsonReader reader)
