 ...
 * <p/>
 * Following is a small example how to use the autogenerated class of the tableview. For that purpose we will first
...
*/
    ...
    */
    ...
    /**
     * Removes a particular row identified by the index from the tableview. The corresponding row of the underlying
