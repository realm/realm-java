...
public class TableQuery implements Closeable {
    ...
    // Not Equal
    public TableQuery notEqualTo(long[] columnIndices, String value, boolean caseSensitive) {
        if (value == null)
            throw new IllegalArgumentException(STRING_NULL_ERROR_MESSAGE);
        nativeNotEqual(nativePtr, columnIndices, value, caseSensitive);
        queryValidated = false;
        return this;
    }
    ...
    protected native void nativeBeginsWith(long nativeQueryPtr, long[] columnIndices, String value, boolean
            caseSensitive);
    ...
    protected native void nativeEndsWith(long nativeQueryPtr, long[] columnIndices, String value, boolean
            caseSensitive);
    ...
    protected native void nativeContains(long nativeQueryPtr, long[] columnIndices, String value, boolean
            caseSensitive);
    ...
    protected native double nativeMaximumDouble(long nativeQueryPtr, long columnIndex, long start, long end, long
            limit);
    ...
    protected native double nativeMinimumDouble(long nativeQueryPtr, long columnIndex, long start, long end, long
            limit);
    ...
    protected native double nativeAverageDouble(long nativeQueryPtr, long columnIndex, long start, long end, long
            limit);
