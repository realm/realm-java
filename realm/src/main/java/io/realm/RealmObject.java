 ...
 * <p/>
 * <ul> <li>Private fields.</li> <li>Getter and setters for these fields.</li> <li>Static methods.</li> </ul>
 * <p/>
 * The following field data types are supported (no boxed types): <ul> <li>boolean</li> <li>short</li> <li>int</li>
 * <li>long</li> <li>float</li> <li>double</li> <li>byte[]</li> <li>String</li> <li>Date</li> <li>Any RealmObject
 * subclass</li> <li>RealmList</li> </ul>
 * <p/>
 ...
 * will have a negative impact on inserts and updates. * <p> A RealmObject cannot be passed between different threads.
 *
...
public abstract class RealmObject {
    ...
    public void removeFromRealm() {
        if (row == null) {
            throw new IllegalStateException("Object malformed: missing object in Realm. Make sure to instantiate " +
                    "RealmObjects with Realm.createObject()");
        }
        if (realm == null) {
            throw new IllegalStateException("Object malformed: missing Realm. Make sure to instantiate RealmObjects " +
    ...
    /**
     * Check if the RealmObject is still valid to use ie. the RealmObject hasn't been deleted nor has the {@link
     * io.realm.Realm} been closed. It will always return false for stand alone objects.
     *
