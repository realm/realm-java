 ...
 */
public class TestTraditionalRealmConfigurationFactory extends TemporaryFolder {
    ...
    public TraditionalRealmConfigBuilder createConfigurationBuilder() {
        return new TraditionalRealmConfigBuilder(context).directory(getRoot());
    }
    ...
    public RealmConfiguration createConfiguration(String subDir, String name, Object module, byte[] key) {
        TraditionalRealmConfigBuilder builder = createConfigurationBuilder();
