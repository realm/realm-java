...
public class JavaTraditionalRealmConfigBuilderTest {
    @Rule
    public final TestTraditionalRealmConfigurationFactory configFactory = new TestTraditionalRealmConfigurationFactory();
