...
public class JavaImmutableNamedParametersRealmConfigBuilderTest {
    @Rule
    public final TestImmutableNamedParametersRealmConfigurationFactory configFactory = new TestImmutableNamedParametersRealmConfigurationFactory();
    ...
    public void getDefaultConfiguration_returnsTheSameObjectThatSetDefaultConfigurationSet() {
        final RealmConfiguration config = new TraditionalRealmConfigBuilder(context).build();
    ...
    public void constructBuilder_nullNameThrows() {
        try {
            configFactory.createConfigurationBuilder(null);
            fail();
        } catch (KotlinNullPointerException ignored) {
        }
    }
    ...
    public void directory_null() {
        configFactory.createConfigurationBuilderWithDirectory(null);
    }
    ...
    public void directory_writeProtectedDir() {
        ...
        configFactory.createConfigurationBuilderWithDirectory(dir);
    }
    ...
    public void directory_dirIsAFile() throws IOException {
        ...
        thrown.expect(IllegalArgumentException.class);
        configFactory.createConfigurationBuilderWithDirectory(file);
    }
    ...
    public void constructBuilder_nullKeyThrows() {
        configFactory.createConfigurationBuilderWithEncryptionKey(null);
    }
    ...
    public void constructBuilder_wrongKeyLengthThrows() {
        ...
        for (byte[] key : wrongKeys) {
            try {
                configFactory.createConfigurationBuilderWithEncryptionKey(key);
    ...
    public void constructBuilder_negativeVersionThrows() {
        configFactory.createConfigurationBuilderWithSchemaVersion(-1);
    }

    @Test
    public void constructBuilder_versionLessThanDiscVersionThrows() {
        MutableNamedParametersRealmConfigBuilder.Companion.mutableRealmConfigBuilder(context, mutableNamedParametersRealmConfigBuilder -> {
            mutableNamedParametersRealmConfigBuilder.assetFilePath(() -> "null");
            return null;
        });
...
//    }
    ...
    public void deleteRealmIfMigrationNeeded_failsWhenAssetFileProvided() {
        ...
        TraditionalRealmConfigBuilder builder = configFactory.createConfigurationBuilder();
        try {
            builder
...
//        Realm.deleteRealm(configFactory.createConfigurationBuilder().build());
//
//        RealmConfiguration configuration = new TraditionalRealmConfigBuilder(context)
//                .modules(new AssetFileModule())
//                .assetFile("asset_file.realm")
//                .build();
...
//    }
    ...
    public void readOnly_initialTransaction_throws() {
        ...
        TraditionalRealmConfigBuilder config = new TraditionalRealmConfigBuilder(context)
                .assetFile("foo")
                .readOnly()
                .initialData(new Realm.Transaction() {
                    @Override
    ...
    public void readOnly_deleteRealmIfMigrationRequired_throws() {
        try {
            ...
            new TraditionalRealmConfigBuilder(context)
                    .assetFile("foo")
                    .readOnly()
                    .deleteRealmIfMigrationNeeded()
                    .build();
    ...
    public void maxNumberOfActiveVersions_throwsIfZeroOrNegative() {
        TraditionalRealmConfigBuilder builder = new TraditionalRealmConfigBuilder(context);
        try {
